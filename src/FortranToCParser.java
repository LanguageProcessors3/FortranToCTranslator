...
public class FortranToCParser extends Parser {
	...
	public static class RContext extends ParserRuleContext {
		...
		public List<TerminalNode> NUM_INT_CONST() { return getTokens(FortranToCParser.NUM_INT_CONST); }
		public TerminalNode NUM_INT_CONST(int i) {
			return getToken(FortranToCParser.NUM_INT_CONST, i);
		}
		public List<TerminalNode> NUM_REAL_CONST() { return getTokens(FortranToCParser.NUM_REAL_CONST); }
		public TerminalNode NUM_REAL_CONST(int i) {
			return getToken(FortranToCParser.NUM_REAL_CONST, i);
		}
		public List<TerminalNode> STRING_CONST() { return getTokens(FortranToCParser.STRING_CONST); }
		public TerminalNode STRING_CONST(int i) {
			return getToken(FortranToCParser.STRING_CONST, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FortranToCListener ) ((FortranToCListener)listener).enterR(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FortranToCListener ) ((FortranToCListener)listener).exitR(this);
		}
	}
